...
test_dataloader_base = dict(
    ...
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
test_dataloader_incremental = dict(
    batch_size=4,
    dataset=dict(
        ann_file='annotations/xray_test_easy.json',
        backend_args=None,
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
test_evaluator = dict(
    ann_file='/home/xray/data/pidray/annotations/xray_test_easy.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
